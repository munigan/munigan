...
All eligible imported items start selected. Unknown/unsupported bag entries stay visible and require explicit exclusion. Invalid equipped gear blocks submission. The allowance is an upper bound; the worker removes illegal or mechanically identical inputs before charging actual work. Paired-slot order is preserved.
