...
export function SavedDraftNotice({
  ...
  return (
    <Alert
      ...
      className="saved-draft-notice mt-0 mb-8 flex-row flex-wrap items-center gap-6 rounded-panel border border-border bg-surface/80 p-6 md:gap-6 max-sm:gap-3 max-sm:p-4"
    >
      {summary ? (
