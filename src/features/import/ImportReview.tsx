...
import { DpsPresetSelect } from "@/features/settings/DpsPresetSelect";
    ...
    <>
      ...
      <div className="import-preset">
        ...
        <DpsPresetSelect
          ...
          placeholder={{ value: "", label: t("chooseSpec") }}
          options={listSpecs().filter((spec) => spec.classId === draft.classId)}
        />
