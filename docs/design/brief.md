...
Status: draft revision 3, awaiting user refinement. Editable source is the user-created [WoW Droptimizer Paper file](https://app.paper.design/file/01M20P4F8A377J1GT1GGCM3K1Z/2-0). No application implementation has started.
...
Desktop: 1440px canvas and 1280px content. Selection uses a 928px inventory and 320px compact run panel; reports use the full content width. Item/action lanes remain fixed; names flex and wrap. Paper artboards have content-driven height. Responsive screen design is still pending.
