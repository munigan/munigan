...
Status: Option 01’s compact layout is implemented, updated with Option 02’s surface background, full border and rounded corners. Restore uses Option 01’s text-only action (15px semibold, 12px icon gap). Actions remain inline to preserve the compact layout.
