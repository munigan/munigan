/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b08158e3ce0a53aa84976be695a6503a)
// Runtime types generated with workerd@1.20260911.1 2026-09-11 nodejs_compat
interface __BaseEnv_Env {
	RELAY_SECRET: string;
	ITEMS: DurableObjectNamespace<import("./src/index").ItemTooltipCache>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ItemTooltipCache";
	}
