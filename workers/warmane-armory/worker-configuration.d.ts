/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f0ae7315a36cf18a629249ffca8e5680)
// Runtime types generated with workerd@1.20260911.1 2026-09-11 nodejs_compat
interface __BaseEnv_Env {
	RELAY_SECRET: string;
	PROFILES: DurableObjectNamespace<import("./src/index").WarmaneProfile>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "WarmaneProfile";
	}
